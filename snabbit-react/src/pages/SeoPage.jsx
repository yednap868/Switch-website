...
function CtaBlock({ service }) {
  return (
    <div className="sp-cta">
      ...
      <a href="https://app.switchlocally.com/employer" className="sp-cta-btn">Get the App — It's Free</a>
    </div>
  )
}
...
function StickyCTA({ service }) {
  ...
  return (
    <div className={`sp-sticky${visible ? ' sp-sticky--show' : ''}`}>
      <a href="https://app.switchlocally.com/employer" className="sp-sticky-btn">Book {service} Now</a>
    </div>
  )
}
        ...
        <div className="sp-hero-inner">
          <div className="sp-hero-text">
            ...
            <div className="sp-hero-btns">
              <a href="https://app.switchlocally.com/employer" className="sp-cta-btn">Book Now — Free App</a>
    ...
    <>
      <section className="sp-hero sp-hero-sm">
        <div className="sp-w">
          ...
          <p className="sp-intro">{page.intro}</p>
          <TrustBadges />
          <a href="https://app.switchlocally.com/employer" className="sp-cta-btn">Find One Near You</a>
        </div>
      </section>
      <section className="sp-section sp-alt">
        <div className="sp-w">
    ...
    <>
      <section className="sp-hero sp-hero-sm">
        <div className="sp-w">
          ...
          <p className="sp-intro">{page.intro}</p>
          <TrustBadges />
          <a href="https://app.switchlocally.com/employer" className="sp-cta-btn">Book for Today</a>
        </div>
      </section>
      <section className="sp-section sp-alt">
        <div className="sp-w">
    ...
    <div className="sp-root">
      ...
      <nav className="sp-nav">
        <div className="sp-nav-inner">
          ...
          <a href="https://app.switchlocally.com/employer" className="sp-nav-cta">Get the App</a>
        </div>
      </nav>
