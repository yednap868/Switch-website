...
const POLICIES = {
  terms: {
    ...
    sections: [
      ...
      { h: '4. Payment', p: 'Monthly subscription plans are billed in advance for the plan period. Hourly, daily and weekly bookings are invoiced against the hours worked, as agreed for your booking. Accepted methods include UPI, cards and bank transfer. Rates depend on role and booking length and are confirmed before the shift. GST and invoices are available for business accounts on request.' },
  ...
  cancellation: {
    ...
    sections: [
      { h: '1. Cancelling a booking', p: 'You can cancel through the app or by messaging us on WhatsApp. Cancelling an hourly or daily booking before a Switch Player is dispatched costs you nothing. For monthly subscription plans, cancellation applies from the end of the current billing period.' },
